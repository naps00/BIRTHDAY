    ...
    <div className="details-page" style={{ overflowY: 'auto', maxHeight: '100vh', padding: '20px' }}>
      ...
      <div
        ...
        style={{
          margin: '10%',
    width: '100%',
    maxWidth: '300px', // ขยายขนาดกล่อง
    padding: '20px',
    borderRadius: '12px', // เพิ่มความโค้งของกล่อง
    backgroundColor: '#ffefef', // เปลี่ยนสีพื้นหลังเป็นสีชมพูอ่อน
    boxShadow: '0 4px 6px rgba(0, 0, 0, 0.2)',
    textAlign: 'left',
    fontSize: '18px', // เพิ่มขนาดตัวอักษร
    lineHeight: '1.8', // ปรับระยะบรรทัด
    whiteSpace: 'pre-line',
    fontFamily: "'Itim', sans-serif", // เพิ่มฟอนต์จาก Google Fonts
    color: '#333', // สีข้อความ

        }}
      >
        <div className="card-message itim-regular">
  <p>สุขสันต์วันเกิดนะพี่เนมkkkkkk⭐️💖</p>
