...
function DetailsPage() {
  ...
  const images = [
    'https://via.placeholder.com/150?text=Card+1', // ภาพที่ 1
    'https://via.placeholder.com/150?text=Card+2', // ภาพที่ 2
    'https://via.placeholder.com/150?text=Card+3', // ภาพที่ 3
  ];
