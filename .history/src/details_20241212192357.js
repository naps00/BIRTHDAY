    ...
    <div className="details-page">
      ...
      <div className="card-stack" {...handlers}>
        {images.map((src, index) => {
          ...
          const zIndex = images.length - Math.abs(currentIndex - index); // สร้างลำดับการซ้อน
          const offsetX = (index - currentIndex) * 10; // การเคลื่อนที่ในแกน X
          const offsetY = (index - currentIndex) * 5; // การเคลื่อนที่ในแกน Y
          const rotation = (index - currentIndex) * 2; // การหมุนภาพ
          ...
          return (
            <img
              ...
              style={{
                ...
                marginLeft: '-100px', // ครึ่งหนึ่งของความกว้าง
                marginTop: '-120px', // ครึ่งหนึ่งของความสูง
                width: '170px',  // ปรับขนาดความกว้างของภาพ
                height: '250px', // ปรับขนาดความสูงของภาพ
              }}
            />
          );
        })}
