...
function Details() {
  ...
  style={{
    margin: '10px auto',
    display: 'block',
    width: '300px', // กำหนดความกว้างของวิดีโอ
    borderRadius: '8px',
    boxShadow: '0 4px 6px rgba(0, 0, 0, 0.1)',
  }}
>
...
<div className="emoji">🌟</div>
      ...
      <audio autoPlay loop>
      <iframe src="https://open.spotify.com/embed/track/4dViJwTNDNHfnlxlLqElqE" width="300" height="380" frameborder="0" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" allowfullscreen></iframe>
